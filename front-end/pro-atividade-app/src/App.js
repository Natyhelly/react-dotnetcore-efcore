  ...
  return (
    <>
      ...
      <Modal show={smShowConfirmModal} onHide={handleConfirmModal}>
        ...
        <ModalFooter>
          <button className="btn btn-success btn-sm me-2" onClick={() => deletarAtividade(atividade.id)}>
            <i className="fas fa-check me-2"></i>
            Sim
          </button>
          <button className="btn btn-danger btn-sm me-2" onClick={() => handleConfirmModal(0)}>
